<?php 
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // username and passwors sent from form

    $myusername = mysqli_real_escape_string($conn, $_POST['korisnik']);
    $mypassword = mysqli_real_escape_string($conn, $_POST['lozinka']);

    $sql = "SELECT id from tbl_applicants WHERE username = '$myusername' and password = '".md5($mypassword)."'";
    ...
    // If resulted matched $myusername and $mypassword, table row muste be 1 row
    ...
    if ($count == 1) {
      ...
      $error = "Your Login Name or Password is invalid<br>Vaše korisničko ime ili lozinka su pogrešni";
    }
        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4">
              ...
              <div style = "font-size:11px; color:#cc0000; text-align: center; margin-top:10px"><?php echo $error; ?></div>
